...
bookingRouter.get('/owner/bookings', authMiddleware, ownerMiddleware, getOwnerBookings);
bookingRouter.patch('/:id/status', authMiddleware, ownerMiddleware, updateBookingStatus);
